...
docker run -d  --name backend_temp flippelip
...
docker exec -it --user root bibliotekdk-next-backend_drupal8_1 /bin/bash -c "chown -R www-data:www-data /var/www/web  && cd /var/www/vendor/bin && php drush cr"
